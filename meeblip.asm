...
DELTA_C:
        .dl	0x000D652E	            ; note  0 ( 8.175799 Hz)

DELTA_CIS:
        .dl	0x000E3117	            ; note  1 ( 8.661957 Hz)

DELTA_D:
        .dl	0x000F091F	            ; note  2 ( 9.177024 Hz)

DELTA_DIS:
        .dl	0x000FEE01	            ; note  3 ( 9.722718 Hz)

DELTA_E:
        .dl	0x0010E07F	            ; note  4 (10.300861 Hz)

DELTA_F:
        .dl	0x0011E167	            ; note  5 (10.913382 Hz)

DELTA_FIS:
        .dl	0x0012F197	            ; note  6 (11.562326 Hz)

DELTA_G:
        .dl	0x001411F6	            ; note  7 (12.249857 Hz)

DELTA_GIS:
        .dl	0x0015437B	            ; note  8 (12.978272 Hz)

DELTA_A:
        .dl	0x0016872B	            ; note  9 (13.750000 Hz)

DELTA_AIS:
        .dl	0x0017DE1A	            ; note 10 (14.567618 Hz)

DELTA_B:
        .dl	0x0019496D	            ; note 11 (15.433853 Hz)

DELTA_C1:
        .dl	0x001ACA5B	            ; note 12 (16.351598 Hz)
